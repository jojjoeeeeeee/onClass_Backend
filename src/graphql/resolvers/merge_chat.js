...
const mailTemplate = (
  ...
  * {
  ...
  <!--[if (mso)|(IE)]><td align="center" width="500" style="background-color: #fdfdfd;width: 500px;padding: 0px;border-top: 0px solid transparent;border-left: 0px solid transparent;border-right: 0px solid transparent;border-bottom: 0px solid transparent;" valign="top"><![endif]-->
  ...
  <table width="100%" cellpadding="0" cellspacing="0" border="0">
    <tr>
      <td style="padding-right: 0px;padding-left: 0px;" align="center">
        ...
        <img align="center" border="0" src="${img}" alt="" title="" style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: inline-block !important;border: none;height: auto;float: none;width: 100%;max-width: 100px;" width="100"/>
  ...
  <table style="font-family:arial,helvetica,sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
    ...
    <div style="font-family: inherit; font-size: 14px; line-height: 140%; text-align: left; word-wrap: break-word;">
      <p style="line-height: 140%;">${firstname} ${lastname} ${optional_name} ส่งข้อความส่วนตัวถึงคุณในชั้นเรียน ${class_name}</p>
    </div>
  ...
  <div align="center">
    <!--[if mso]><v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="http://ec2-54-255-229-73.ap-southeast-1.compute.amazonaws.com/${class_code}" style="height:37px; v-text-anchor:middle; width:92px;" arcsize="11%"  stroke="f" fillcolor="#41b094"><w:anchorlock/><center style="color:#FFFFFF;font-family:arial,helvetica,sans-serif;"><![endif]-->  
      <a href="http://ec2-54-255-229-73.ap-southeast-1.compute.amazonaws.com/${class_code}" target="_blank" class="v-button" style="box-sizing: border-box;display: inline-block;font-family:arial,helvetica,sans-serif;text-decoration: none;-webkit-text-size-adjust: none;text-align: center;color: #FFFFFF; background-color: #41b094; border-radius: 4px;-webkit-border-radius: 4px; -moz-border-radius: 4px; width:auto; max-width:100%; overflow-wrap: break-word; word-break: break-word; word-wrap:break-word; mso-border-alt: none;font-size: 14px;">
        <span style="display:block;padding:10px 20px;line-height:120%;"><span style="line-height: 16.8px;">ตอบกลับ</span></span>
      </a>
...
const sendPrivateMessage = async (parent, args, req) => {
  ...
  try {
    ...
    if (conversation_data) {
      ...
      const receiver = await Users.findById(args.receiver_id);
      if (!receiver) return "FAIL: sendPrivateMessage receiver not found";
      for (let j = 0; j < class_data.nickname.length; j++) {
        if (args.sender_id == class_data.nickname[j].user_id) {
          mailer(
            receiver.email,
            `${class_data.nickname[j].firstname} ได้ส่งข้อความส่วนตัวหาคุณในชั้นเรียน ${class_data.class_name}`,
            mailTemplate('cid:onClassLogo', class_data.nickname[j].firstname, class_data.nickname[j].lastname
            , class_data.nickname[j].optional_name, class_data.class_name, class_code)
          );
